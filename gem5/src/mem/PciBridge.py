...
import os 
home = os.getenv('HOME')
sys.path.append(str(home) + '/LSAIN-Simulator/gem5/src/mem')
...
###Bridge related params
    slave = ResponsePort("This port receives requests and sends "
                                             "responses")
    master1 = RequestPort("This port sends requests and receives "
                                              "responses")
    master2 = RequestPort("This port sends requests and receives "
                                              "responses")
    master3 = RequestPort("This port sends requests and receives "
                                              "responses")
    slave_dma1 = ResponsePort("This port receives requests and sends "
                                                  "responses")
    master_dma = RequestPort("This port sends requests and receives "
                                                 "responses")
    slave_dma2 = ResponsePort("This port receives requests and sends "
                                                  "responses")
    slave_dma3 = ResponsePort("This port receives requests and sends "
                                                  "responses")
