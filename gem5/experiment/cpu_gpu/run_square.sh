docker run -u $UID:$GID --volume $(pwd):$(pwd) -w $(pwd) gcr.io/gem5-test/gcn-gpu:v22-0 \
	   ...
	   -d experiment_out/cpu_gpu_multilinks/square_result/square_result_p100dgx1 \
...
docker run -u $UID:$GID --volume $(pwd):$(pwd) -w $(pwd) gcr.io/gem5-test/gcn-gpu:v22-0 \
       build/GCN3_X86/gem5.opt \
	   -d experiment_out/cpu_gpu_multilinks__1/square_result/square_result_v100dgx1 \
	   configs/example/apu_se.py \
	   -n 4 \
	   -u 16 \
	   --num-dir=16 \
...
# docker run -u $UID:$GID --volume $(pwd):$(pwd) -w $(pwd) gcr.io/gem5-test/gcn-gpu:v22-0 \
#        build/GCN3_X86/gem5.opt \
# 	   -d experiment_out/square_result_p100dgx1 \
# 	   configs/example/apu_se.py \
# 	   -n 4 \
# 	   -u 16 \
# 	   --num-dir=16 \
